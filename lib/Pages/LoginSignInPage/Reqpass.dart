...
class Reqpass extends StatefulWidget {
  const Reqpass({super.key});

  @override
  State<Reqpass> createState() => _ReqpassState();
}

class _ReqpassState extends State<Reqpass> {
  ...
  void initState() {
    super.initState();
    // Add a listener to the password controller to check requirements
  ...
  // This function is called every time the user types in the password field
  ...
  // --- Helper for the Password Requirement Checklist ---
  Widget _buildRequirementRow(bool met, String text) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 2.0),
      child: Row(
        children: [
          // We use a small container to mimic the Checkbox size
          Container(
            width: 20,
            height: 20,
            decoration: BoxDecoration(
              color: met ? Colors.blue : Colors.grey[200],
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Required Password',
                  style: TextStyle(
                    color: Colors.orange, // Switched to orange as in picture
                    fontSize: 12,
                  ),
                ),
                const SizedBox(height: 8),

                // --- NEW: Password Requirements Box ---
                Container(
                  padding:
                  ...
                  child: Column(
                    children: [
                      _buildRequirementRow(
                          _has8Chars, 'Add at least 8 characters'),
                      _buildRequirementRow(
                          _hasUpperCase, 'Add at least 1 upper case'),
                      _buildRequirementRow(
                          _hasLowerCase, 'Add at least 1 lower case'),
                      _buildRequirementRow(_hasSpecialChar, 'Add special case'),
                      _buildRequirementRow(_hasNumber, 'Add number'),
                    ],
                  ),
                ),
                // --- End of New Box ---
